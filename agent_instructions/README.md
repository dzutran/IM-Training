# Agent Instruction Folder

This folder contains the mandatory rules and initialization procedures for all AI agents working on this project.
...
- `RULES.md`: The core implementation rules.
- `TASK_CHECKLIST.md`: A template for task execution (to be used in `task.md`).
