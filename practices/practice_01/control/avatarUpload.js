function init(request) {
  ...
  try {
    // Define paths
    var sessionPath = "training/zzz/session/practice01/avatar";
    var publicPath = "training/zzz/public/practice01/avatar";

    var parameters = request.getParameters('avatarUpload');
